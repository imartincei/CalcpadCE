...
> The panel described here is the same in the [VS Code extension](new-vscode-extension.md) and [desktop app](new-desktop-app.md) — it is built from one shared set of components. Where a host behaves differently, it is called out below.
